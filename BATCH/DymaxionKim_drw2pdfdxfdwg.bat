...
call E:\GrabCAD\CREO3_STARTUP_DJDMP\BATCH\BatchSubstitute.bat .drw.1 . %1\dir1.txt > %1\dir2.txt
...
cd /d E:\GrabCAD\CREO3_STARTUP_DJDMP
"C:\PTC\Creo 3.0\M010\Parametric\bin\parametric.exe" %WorkPath%\trail.txt
